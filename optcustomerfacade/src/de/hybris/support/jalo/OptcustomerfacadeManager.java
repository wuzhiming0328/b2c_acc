 ...
 *
 */
package de.hybris.support.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.util.JspContext;
import de.hybris.support.constants.OptcustomerfacadeConstants;
...
/**
 * This is the extension manager of the Optcustomerfacade extension.
 */
public class OptcustomerfacadeManager extends GeneratedOptcustomerfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OptcustomerfacadeManager.class.getName());
	 ...
	 */
	public static OptcustomerfacadeManager getInstance()
	{
		return (OptcustomerfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(OptcustomerfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OptcustomerfacadeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OptcustomerfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OptcustomerfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OptcustomerfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
